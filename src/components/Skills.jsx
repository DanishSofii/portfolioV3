        ...
        <div id="skills" className=" bg-slate-900 h-[55vh] md:h-[50vh] p-[2rem] md:p-[3rem] lg:p-[8rem] flex justify-center items-center flex-col">
            ...
            <div>
                ...
                {skills.map((skill,index)=>(
                    <li key={index} className="text-slate-50 flex justify-center items-center flex-wrap font-thin w-[5rem] m-[0.5rem] h-10 md:m-[1rem] md:h-12 md:w-20 bg-zinc-800 border border-slate-50 outline-none rounded-sm hover:bg-slate-800 gradient-border">{skill}</li>
                ))}
                </ul>
            </div>
        </div>
